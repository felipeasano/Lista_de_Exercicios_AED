/*
    Implemente a funcao Lista* pares(Lista* l)
    que retorna uma lista contendo os numeros pares da lista passada como parametro
*/
#include<stdio.h>
#include<stdlib.h>
...
// Conta o numero de ocorrencias de um elemento x na lista
// Entrada: Lista a ser contada, elemento a ser considerado
// Retorno: Quantidade de vezes q o elemento x repete na lista
// Pre-Condicao: Nenhuma
// Pos-Condicao: Nenhuma
int conta_ocorrencias(Lista* l, int x){
    ...
    }else return conta_ocorrencias(l->prox, x); 
}

// Elimina elementos repetidos, deixando somente uma unica ocorrencia de cada elemento
// Entrada: Lista a ser alterada
// Retorno: Lista sem elementos repetidos
// Pre-Condicao: Nenhuma
// Pos-Condicao: Elementos repetidos na lista sao retirados
Lista* elimina_repetidos(Lista* l){
    if(vazia(l)) return NULL;
    l->prox = remover(l->prox, l->info);
    l->prox = elimina_repetidos(l->prox);
    return l;
}

// Retorna uma lista contendo os numeros pares da lista passada como parametro
// Entrada: Lista a ser alterada
// Retorno: Lista contendo apenas numeros pares da lista passada como parametro
// Pre-Condicao: Nenhuma
// Pos-Condicao: Lista contendo apenas numeros pares da lista passada como parametro
Lista* pares(Lista* l){
