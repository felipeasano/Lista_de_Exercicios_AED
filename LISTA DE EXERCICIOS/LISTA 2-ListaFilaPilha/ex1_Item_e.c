/*
    implemente a funcao int conta_ocorrencias(Lista* l, int x)
    que retorna o numero de ocorrencias do elemento x na lista.
*/
#include<stdio.h>
#include<stdlib.h>
...
int main(){
    ...
    printf("\n\nO elemento 2 repete %d vezes na lista 2", conta_ocorrencias(l2, 2));
    return 0;
}